...
CREATE TABLE reservations (
    ...
    check_in_effectue BOOLEAN DEFAULT FALSE,
    date_heure_check_in TIMESTAMP,
    client_nom VARCHAR(100),
    client_prenom VARCHAR(100),
    client_email VARCHAR(255),
    client_telephone VARCHAR(50),
    client_type_piece_identite VARCHAR(50),
    client_numero_piece_identite VARCHAR(100),
    client_nationalite VARCHAR(100),
    client_date_naissance DATE,
    nombre_personnes INT DEFAULT 1,
    remarques_check_in TEXT,
    methode_paiement_check_in VARCHAR(50),
    date_creation TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
